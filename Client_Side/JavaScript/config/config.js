...
config.participants.users.regulators[0].user = 'Bhavesh';
...
config.participants.users.lease_companies[0].company = 'Parth';
config.participants.users.lease_companies[0].type = 'Lease Company';
config.participants.users.lease_companies[0].user = 'Parth';

config.participants.users.lease_companies[1] = {};
config.participants.users.lease_companies[1].company = 'Kunal';
config.participants.users.lease_companies[1].type = 'Lease Company';
config.participants.users.lease_companies[1].user = 'Kunal';

config.participants.users.lease_companies[2] = {};
config.participants.users.lease_companies[2].company = 'Mrunal';
config.participants.users.lease_companies[2].type = 'Lease Company';
config.participants.users.lease_companies[2].user = 'Mrunal';
