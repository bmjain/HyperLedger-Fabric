		...
		for(var i = 0; i < array.length; i++)
		{
			if(array[i].trim() != "")
			{
				...
				if(!found)
				{
					...
					{
						if(typeof obj.message == 'undefined' && obj.VIN > 0 && obj.VIN > 0 && obj.make.toLowerCase() != 'undefined' && obj.make.trim() != '' && obj.model.toLowerCase() != 'undefined' && obj.model.trim() != '' && obj.colour.toLowerCase() != 'undefined' && obj.colour.trim() != '' && !obj.scrapped)
						{
							objects.push(obj)
						}
					}
	...
	xhr.onreadystatechange = function (){
		if(xhr.readyState === 4)
		{
			if(!error)
			{
				...
				{
					var data = objects[i];
					$("#vhclsTbl").append("<tr class='vehRw'><td class='vin'>"+data.VIN+"</td><td class='vehDets' ><span class='carInfo'>" + data.make + "</span><span class='carInfo'>" + data.model + ", </span><span class='carInfo'>" + data.year + "</span><span class='carInfo'>" + data.colour + ", </span><span class='carInfo'>" + data.MSRP + "</span></td><td class='chkHldr'><span class='chkSpc' ></span><span class='chkBx' ></span><input class='isChk' type='hidden' value='false' /><input class='MSRP' type='hidden' value='"+data.MSRP+"' /><input class='v5cID' type='hidden' value='"+data.v5cID+"' /></td></tr>");
				}
				changeBarSize();
			}
		}
	...
	xhr.onreadystatechange = function (){
		if(xhr.readyState === 4)
		{
			...
			for(var i = 0; i < d.length; i++)
			{
				...
				if(data.MSRP == 0) data.MSRP = '&lt;<i>MSRP</i>&gt;';
