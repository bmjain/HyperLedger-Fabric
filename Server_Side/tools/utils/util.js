...
class Util {
    static queryChaincode(securityContext, functionName, args,request) {
        ...
        try {
            ...
            return new Promise(function(resolve, reject) {
                ...
                tx.on('complete', function(data) {
                      request.V5cID = args[0];
              //      console.log("*********************Transaction*******************");
               //     console.log(JSON.stringify({result:data.result,answer:request}));
                //    console.log("**********************Transaction******************");
                  
                    resolve({result:data.result,answer:request});
                });
