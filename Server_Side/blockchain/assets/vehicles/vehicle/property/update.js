...
{
    console.log("before populating vehicle data");
    vehicleData = new Vehicle(usersToSecurityContext);
    console.log("after populating vehicle data");
    let newValue = req.body.value;
    let newValue1="";
    var booleanval=false;
    if(req.body.value1)
    {
        newValue1=req.body.value1;
    }
    else
    {
        newValue1="no state";
    }
    console.log(" the argument is "+newValue);
    //let newValue1 = req.body.value1;
    ...
    return vehicleData.updateAttribute(user_id, functionName, newValue,newValue1,v5cID)
    .then(function(data) {
