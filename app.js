...
var createVehicles = require(__dirname + '/Server_Side/blockchain/assets/vehicles/CRUD/create.js');
let createVehicle         = require(__dirname+'/Server_Side/blockchain/assets/vehicles/CRUD/createVehicle.js');
var readVehicles = require(__dirname + '/Server_Side/blockchain/assets/vehicles/CRUD/read.js');
var updateVehicles = require(__dirname + '/Server_Side/blockchain/assets/vehicles/CRUD/update.js');
var transferVehicles = require(__dirname + '/Server_Side/blockchain/assets/vehicles/CRUD/transfer.js');
let read = require(__dirname + '/Server_Side/blockchain/assets/vehicles/vehicle/property/read');
let update = require(__dirname + '/Server_Side/blockchain/assets/vehicles/vehicle/property/update');
let vehicleRead = require(__dirname + '/Server_Side/blockchain/assets/vehicles/vehicle/CRUD/read.js');
let vehicleDelete = require(__dirname + '/Server_Side/blockchain/assets/vehicles/vehicle/CRUD/delete.js');

let demo = require(__dirname + '/Server_Side/admin/demo/demo.js');
let chaincodeCreateVehicle = require(__dirname + '/Server_Side/blockchain/chaincode/create.js');
let transactions = require(__dirname + '/Server_Side/blockchain/transactions/transactions.js');
let transactionsbyv5cid = require(__dirname + '/Server_Side/blockchain/transactions/CRUD/readbyv5cid.js');
...
app.post('/blockchain/chaincode/vehicles', function (req, res, next) {
    chaincodeCreateVehicle(req, res, next, usersToSecurityContext);
});
...
app.post('/blockchain/assets/vehicles', function (req, res, next) {
    createVehicles.create(req, res, next, usersToSecurityContext);
});

app.post('/blockchain/assets/createVehicle' , function(req,res,next)
{
    createVehicle.create(req,res,next,usersToSecurityContext);
});


//---------------------------------------NOT USED-------------------------------------
app.post('/blockchain/assets/getallvehicles', function (req, res, next) {
    readVehicles.read(req, res, next, usersToSecurityContext);
});

//---------------------------------------USED-------------------------------------
app.post('/blockchain/assets/getvehicles', function (req, res, next) {
    readVehicles.readbyownertype(req, res, next, usersToSecurityContext);
});

//---------------------------------------USED-------------------------------------
app.post('/blockchain/assets/vehiclesbyManufacturer', function (req, res, next) {
    readVehicles.read(req, res, next, usersToSecurityContext,"Manufacturer");
});

//---------------------------------------USED-------------------------------------
app.post('/blockchain/assets/vehiclesbyDealer', function (req, res, next) {
    readVehicles.read(req, res, next, usersToSecurityContext,"Dealer");
});
//---------------------------------------USED-------------------------------------
app.post('/blockchain/assets/vehiclesbyBuyer', function (req, res, next) {
    readVehicles.read(req, res, next, usersToSecurityContext,"Private");
});

//---------------------------------------USED-------------------------------------
app.post('/blockchain/assets/updatevehicle', function (req, res, next) {
    updateVehicles.update(req, res, next, usersToSecurityContext);
});

//---------------------------------------USED-------------------------------------
app.post('/blockchain/assets/transfervehicle', function (req, res, next) {
    transferVehicles.transfer(req, res, next, usersToSecurityContext);
});
...
app.get('/blockchain/assets/vehicles/:v5cID', function (req, res, next) {
    vehicleRead(req, res, next, usersToSecurityContext);
});
...
app.get('/blockchain/assets/vehicles/:v5cID/owner', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "owner");
});

app.put('/blockchain/assets/vehicles/:v5cID/owner', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "owner");
});

//-----------------------------------------------------------------------------------------------
//    Blockchain - Assets - Vehicles - Vehicle - year
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/vehicles/:v5cID/year', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "year");
});

app.put('/blockchain/assets/vehicles/:v5cID/year', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "year");
});

//-----------------------------------------------------------------------------------------------
//    Blockchain - Assets - Vehicles - Vehicle - State
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/vehicles/:v5cID/State', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "State");
});

app.put('/blockchain/assets/vehicles/:v5cID/State', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "State");
});

//-----------------------------------------------------------------------------------------------
//    Blockchain - Assets - Vehicles - Vehicle - StateTax
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/vehicles/:v5cID/StateTax', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "StateTax");
});

app.put('/blockchain/assets/vehicles/:v5cID/StateTax', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "StateTax");
});

//-----------------------------------------------------------------------------------------------
//    Blockchain - Assets - Vehicles - Vehicle - SellingPrice
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/vehicles/:v5cID/SellingPrice', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "SellingPrice");
});

app.put('/blockchain/assets/vehicles/:v5cID/SellingPrice', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "SellingPrice");
});
...
app.get('/blockchain/assets/vehicles/:v5cID/VIN', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "VIN");
});

app.put('/blockchain/assets/vehicles/:v5cID/VIN', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "VIN");
});

//-----------------------------------------------------------------------------------------------
//    Blockchain - Assets - Vehicles - Vehicle - MSRP
//-----------------------------------------------------------------------------------------------
app.get('/blockchain/assets/vehicles/:v5cID/MSRP', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "MSRP");
});

app.put('/blockchain/assets/vehicles/:v5cID/MSRP', function (req, res, next) {

    update(req, res, next, usersToSecurityContext, "MSRP");
});
...
app.get('/blockchain/assets/vehicles/:v5cID/colour', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "colour");
});

app.put('/blockchain/assets/vehicles/:v5cID/colour', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "colour");
});
...
app.get('/blockchain/assets/vehicles/:v5cID/make', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "make");
});

app.put('/blockchain/assets/vehicles/:v5cID/make', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "make");
});
...
app.get('/blockchain/assets/vehicles/:v5cID/model', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "model");
});

app.put('/blockchain/assets/vehicles/:v5cID/model', function (req, res, next) {
    update(req, res, next, usersToSecurityContext, "model");
});
...
app.get('/blockchain/assets/vehicles/:v5cID/reg', function (req, res, next) {
    read(req, res, next, usersToSecurityContext, "reg");
});

app.put('/blockchain/assets/vehicles/:v5cID/reg', function (req, res, next) {

    update(req, res, next, usersToSecurityContext, "reg");
});
...
app.delete('/blockchain/assets/vehicles/:v5cID', function (req, res, next) {
    vehicleDelete(req, res, next, usersToSecurityContext);
});
...
app.post('/blockchain/transactions', function (req, res, next) {
    transactions.read(req, res, next, usersToSecurityContext);
});

app.get('/blockchain/transactions/:v5cID', function (req, res, next) {
    transactionsbyv5cid.read(req, res, next, usersToSecurityContext);
});
app.post('/blockchain/transactions/:v5cID', function (req, res, next) {
    transactionsbyv5cid.read(req, res, next, usersToSecurityContext);
});
